...
public class FunkTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//RF24 radio = new RF24((short) 22/* RPI_V2_GPIO_P1_15 */, (short) 8/* RPI_V2_GPIO_P1_24 */,
		//		(long) 32/* BCM2835_SPI_SPEED_8MHZ */);
				
		RF24 radio = new RF24((short)11, (short)24);

		BigInteger pipes[] = { new BigInteger("110010101100100011011110100111000110001", 2) /* "1Node" */,
				new BigInteger("110010101100100011011110100111000110010", 2) /* "2Node" */ };
		...
		System.out.println("Before radio begin");
		radio.begin();
		System.out.println("After radio begin");
		...
		while (true) {
			if (role == role_ping_out) {
				...
				// Increment the counter, and send it. This will block until
				// complete
				counter++;
			...
			//
			// Pong back role. Receive each packet, dump it out, and send it
			// back
			//
			...
			if (role == role_pong_back) {
				...
				if (radio.available()) {
					...
					Thread.sleep(925); // Delay after payload responded to,
										// minimize RPi CPU time
